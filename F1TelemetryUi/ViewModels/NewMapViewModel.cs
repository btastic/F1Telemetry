...
namespace F1TelemetryUi.ViewModels
{
    ...
    public class NewMapViewModel : PropertyChangedBase
    {
        public NewMapViewModel()
        {
            ...
            var pathGeo = tempGeo.GetFlattenedPathGeometry();

            var point = new System.Windows.Point();
            var tangent = new System.Windows.Point();

            tempGeo.GetOutlinedPathGeometry().GetPointAtFractionLength(1.0f, out point, out tangent);
            //tempGeo.GetFlattenedPathGeometry().GetPointAtFractionLength(1.0f, out point, out tangent);
